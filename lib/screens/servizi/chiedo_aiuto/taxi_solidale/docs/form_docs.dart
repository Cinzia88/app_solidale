...
class FormDocsTaxi extends StatefulWidget {
  const FormDocsTaxi({super.key});

  @override
  State<FormDocsTaxi> createState() => _FormDocsTaxiState();
}

class _FormDocsTaxiState extends State<FormDocsTaxi> {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    bloc.add(SendDocsFormEvent(
                                        ...
                                        setState(() {
                                              ...
                                              await ValueSharedPrefsViewSlide().setProfiloIncompletoUtenteFilesTaxi(filesIncompleti!);
