...
class EditBancoAlim extends StatefulWidget {
  RequestData listRequestData;
   EditBancoAlim(this.listRequestData);

  @override
  State<EditBancoAlim> createState() => _EditBancoAlimState();
}
List<String> serviceId = ['2', '3', '4'];


class _EditBancoAlimState extends State<EditBancoAlim> {
